...
app.get("/scrape", function (req, res) {
  ...
  axios.get("https://www.unicefusa.org/").then(function (response) {
    // Then, we load that into cheerio and save it to $ for a shorthand selector
    var $ = cheerio.load(response.data);

    // Now, we grab every h2 within an article tag, and do the following:
    $(".our-stories-sub-title").each(function (i, element) {
...
app.put("/saved/:id", function (req, res) {
  ...
  // and setting the saved field to true
  db.Article.findOneAndUpdate({ _id: req.params.id }, { saved: true }, { new: true }, function (data) {
    res.json(data);
